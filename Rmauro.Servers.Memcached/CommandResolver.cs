...
public class CommandResolver : ICommandResolver
{
    ...
    public (string, string, string) CommandArgs(string command)
    {
        ...
        switch (commandName.ToString())
        {
            ...
            case Commands.Get:
                ...
                return (commandName.ToString(), key2.ToString(), string.Empty);

            case Commands.FlushAll:
                return (commandName.ToString(), string.Empty, string.Empty);
        }
        return (string.Empty, string.Empty, string.Empty);
    }

    public (string, string, string) CommandArgs(ReadOnlySpan<char> command)
    {
